...
public class ProjectController {
    ...
    //发起验收项目  通过id获取并且修改状态为待验收
    @UserLoginToken
    @Role("admin")
    @RequestMapping(value = "/unacceptance/{id}",method = RequestMethod.PUT)
    public R<String> unacceptProject(@PathVariable Long id){
        Project project = service.getProjectById(id);
//        //总的开发人数
...
//        project.setTotalpersondays(totalpersondays);
        //System.out.println(project);
        project.setPstatus("待验收");
//        project.setNumofdev(numofdev);
        service.create(project);
        return R.success("恭喜你，发起验收成功");
